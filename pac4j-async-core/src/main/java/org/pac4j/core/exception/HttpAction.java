...
public class HttpAction extends Exception {
     ...
     */
    public static HttpAction status(final String message, final int status, final WebContextBase  context) {
     ...
     */
    public static HttpAction redirect(final String message, final WebContextBase  context, final String url) {
     ...
     * @return an HTTP ok
     */
    public static HttpAction ok(final String message, final WebContextBase  context) {
     ...
     * @return an HTTP ok
     */
    public static HttpAction ok(final String message, final WebContextBase  context, String content) {
     ...
     */
    public static HttpAction unauthorized(final String message, final WebContextBase  context, final String realmName) {
     ...
     */
    public static HttpAction unauthorizedDigest(final String message, final WebContextBase  context, final String realmName, final String qop, final String nonce) {
        if (CommonHelper.isNotBlank(realmName)) {
     ...
     */
    public static HttpAction forbidden(final String message, final WebContextBase  context) {
